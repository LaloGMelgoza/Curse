...
/* These are used to eliminate warnings such as singleton variable use */
...
trade(beer_tankard) :-
        ...
        write('Beggar: Took you long enough. Yes yes take it, just give me my beer.'), nl, nl, %sleep(1),
